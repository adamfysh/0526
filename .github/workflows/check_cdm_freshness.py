...
deployed public/simulator_data.json actually got between manual reruns. This
checks the "generated" date already embedded in the deployed file and fails
loudly if it has crossed the staleness threshold, so a forgotten rebuild gets
noticed instead of silently serving old dependency figures on the live site.
"""
...
PATH = "public/simulator_data.json"
